...
public class ItemButton : MonoBehaviour {
	...
	public void Press(){
		//Shop.instance.itemsForSale[buttonValue] => the button values are a ref to the element index in the array of items from a npc items to sell, 
		//GameManager.instance.itemsHeld[buttonValue]) => refers to the item from the player inv => the item names array
